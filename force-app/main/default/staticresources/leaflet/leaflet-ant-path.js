...
! function(t, e) {
    ...
    return function(t) {
        ...
        19: function(t, e, n) {
            ...
            if (r.regeneratorRuntime = void 0, t.exports = n(20), o) r.regeneratorRuntime = i;
            else try {
        ...
        20: function(t, e) {
            ! function(e) {
                ...
                if (l) c && (t.exports = l);
                    ...
                    var b = k.prototype = L.prototype = Object.create(m);
                    O.prototype = b.constructor = k, k.constructor = O, k[u] = O.displayName = "GeneratorFunction", l.isGeneratorFunction = function(t) {
                ...
                function S(t, e) {
                    ...
                    if (r === n) {
                        if (e.delegate = null, "throw" === e.method) {
                            if (t.iterator.return && (e.method = "return", e.arg = n, S(t, e), "throw" === e.method)) return y;
        ...
        24: function(t, e, n) {
            ...
            function g(t, e) {
                ...
                if (e.singleton) {
                    var a = c++;
                    n = u || (u = m(e)), r = _.bind(null, n, a, !1), o = _.bind(null, n, a, !0)
        ...
        38: function(t, e, n) {
            ...
            var d = {
                ...
                w = function(t) {
                    function e(t) {
                        var n, o, i, s = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                        return function(t, e) {
                            if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
                        }(this, e), o = this, n = !(i = l(e).call(this)) || "object" !== a(i) && "function" != typeof i ? h(o) : i, p(h(h(n)), y, null), p(h(h(n)), m, null), p(h(h(n)), "_map", null), p(h(h(n)), "_path", null), p(h(h(n)), "_animatedPathId", null), p(h(h(n)), "_animatedPathClass", "leaflet-ant-path"), p(h(h(n)), "_reversePathClass", "".concat(n._animatedPathClass, "__reverse")), p(h(h(n)), "_hardwareAccClass", "hardware-acceleration"), p(h(h(n)), "_defaultOptions", {
                            use: r.polyline,
                            paused: !1,
                            reverse: !1,
                            ...
                            color: "#0000FF",
                            pulseColor: "#FFFFFF"
                        }), r.Util.setOptions(h(h(n)), u({}, n._defaultOptions, s)), n._path = t, n._animatedPathId = "ant-path-".concat((new Date).getTime()), n._mount(), n
                    }
                    var n, o, w;
                    return function(t, e) {
                        ...
                        key: "map",
                        value: function(t) {
                            return new(0, this.constructor[Symbol.species])(this._path.map(t), u({}, this.options))
                        }
                    }, {
                        key: b,
                        ...
                        value: function() {
                            var t = this.options,
                                ...
                                s = u({}, t),
                                c = u({}, t);
                            return c.color = c.pulseColor || t.pulseColor, c.className = [e, o, i ? n : "", a ? "".concat(e, "__").concat(r) : ""].join(" "), delete s.dashArray, Array.isArray(c.dashArray) && (c.dashArray = String(c.dashArray)), {
                                pathOpts: s,
                                pulseOpts: c
                            }
                        }
                        ...
                        value: function() {
                            var t = this._processOptions(),
                                ...
                                n = t.pulseOpts,
                                r = this.options.use;
                            this.addLayer(this[d.main] = r(this._path, e)), this.addLayer(this[d.pulse] = r(this._path, n))
                        }
                    }, {
                        ...
                        key: "onRemove",
                        value: function(t) {
                            return this._map && (this._map.off("zoomend", this._calculateAnimationSpeed, this), this._map = null), t && t.removeLayer(this[d.main]).removeLayer(this[d.pulse]), this
                        }
                    }, {
                        key: "pause",
                        value: function() {
                        ...
                        key: "bringToFront",
                        value: function() {
                            return this[d.main].bringToFront(), this[d.pulse].bringToFront(), this
                        }
                    }, {
                        key: "bringToBack",
                        value: function() {
                            return this[d.pulse].bringToBack(), this[d.main].bringToBack(), this
                        }
                    }, {
                        key: "removeFrom",
                        value: function(t) {
                        ...
                        value: function(t) {
                            var e = t.paused,
                                n = t.delay,
                                r = t.reverse;
                            e ? this.pause() : this.resume(), n !== this.options.delay && (this.options.delay = n || this._defaultOptions.delay, this._calculateAnimationSpeed()), void 0 !== r && r !== this.options.reverse && this._pureReverse(), this.options = u({}, this.options, t);
                            var o = this._processOptions(),
                                i = o.pathOpts,
                                a = o.pulseOpts;
                            return this[d.main].setStyle(i), this[d.pulse].setStyle(a), this
                        }
                    }, {
                        key: "reverse",
                        value: function() {
                        ...
                        key: "redraw",
                        value: function() {
                            return this[d.main].redraw(), this[d.pulse].redraw(), this
                        }
                    }, {
                        key: "addLatLng",
                        value: function() {
                            for (var t, e, n = arguments.length, r = new Array(n), o = 0; o < n; o++) r[o] = arguments[o];
                            return this._path = [].concat(s(this._path), [r]), (t = this[d.main]).addLatLng.apply(t, r), (e = this[d.pulse]).addLatLng.apply(e, r), this
                        }
                    }, {
                        key: "setLatLngs",
                        value: function() {
                            for (var t, e, n = arguments.length, r = new Array(n), o = 0; o < n; o++) r[o] = arguments[o];
                            return this._path = r, (t = this[d.main]).setLatLngs.apply(t, r), (e = this[d.pulse]).setLatLngs.apply(e, r), this
                        }
                    }, {
                        key: "getLatLngs",
                        value: function() {
                            return this[d.main].getLatLngs()
                        }
                    }, {
                        key: "spliceLatLngs",
                        value: function() {
                            var t, e, n = (t = this[d.main]).spliceLatLngs.apply(t, arguments);
                            return (e = this[d.pulse]).spliceLatLngs.apply(e, arguments), n
                        }
                    }, {
                        key: "getBounds",
                        value: function() {
                            return this[d.main].getBounds()
                        }
                    }, {
                        key: "toGeoJSON",
                        value: function() {
                            return this[d.main].toGeoJSON()
                        }
                    }, {
                        key: g,
                        get: function() {
            ...
            n.d(e, "AntPath", function() {
                ...
                return O
            }), r.Polyline.AntPath = w, r.polyline.antPath = _;
            var L = w,
                O = _;
            e.default = {
                AntPath: L,
